...
public class Ventana_Grid extends JFrame{
    ...
    public Ventana_Grid(int numV){
        ...
        this.add(new Panel_ventana(), BorderLayout.CENTER);
    ...
    class Panel_Jugadores extends JPanel{
        ...
        public Panel_Jugadores(int jugador){
            setLayout(new GridLayout(2, 2)); // Es una "Matriz" para poner 
